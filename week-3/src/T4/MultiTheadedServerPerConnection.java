...
public class MultiTheadedServerPerConnection implements Runnable {
    ...
    MultiTheadedServerPerConnection(Socket socket) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            while (true) {
                ...
                new Thread(new MultiTheadedServerPerConnection(socket)).start();
            }
